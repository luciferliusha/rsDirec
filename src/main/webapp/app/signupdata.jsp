...
<div style="text-align:center">
	...
	<div id="w" class="easyui-window" title="数据资源注册" data-options="iconCls:'icon-save'" style="width:800px;height:400px;padding:5px;">
		<div class="easyui-layout" data-options="fit:true">
			<div style="margin-bottom:20px">
				<div>资源所属单位</div>
				<input id="data_dept" class="easyui-textbox" data-options="prompt:'Enter a email address...',validType:'email'" style="width:50%;height:32px">
			</div>
			<div style="margin-bottom:20px">
				<div>资源所属分类</div>
				<input  id="data_group" class="easyui-textbox" style="width:50%;height:32px">
			</div>
			<div style="margin-bottom:20px">
				<div>资源名称</div>
				<input  id="data_name" class="easyui-textbox" style="width:50%;height:32px">
			</div>
			<div style="margin-bottom:20px">
				<div>资源获取方式</div>
